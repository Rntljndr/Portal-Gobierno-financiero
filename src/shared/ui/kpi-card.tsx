...
export function KpiCard({ label, value, valueSize = 'lg', icon, iconBg, delta }: KpiCardProps) {
  return (
    <div className="rounded-xl border border-border-table bg-white p-[16px_18px_18px] transition-all hover:-translate-y-px hover:shadow-[0_8px_24px_rgba(6,20,148,0.08)]">
